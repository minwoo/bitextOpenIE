...
import openie.text.KoreanFeatureFactory;
import openie.text.KoreanFeatureFactory.Node;

public class Treebank_KR_DataBuilder {
	
	private PrintStream trainStream = null;
	private PrintStream testStream = null;
    
	public Treebank_KR_DataBuilder(PrintStream trainStream, PrintStream testStream) {
...
//	static public int numNNG = 0;
	...
	public boolean printInstance(String line, BufferedWriter outputWriter) throws IOException {
		...
		KoreanFeatureFactory.tokenizeString(e1String, sequence, "ENT");
		...
		KoreanFeatureFactory.tokenizeString(rightContextOfARG2, sequence);
...
//		}
		...
		ArrayList<ArrayList<String>> featureForm = KoreanFeatureFactory.generateFeature(sequence, wordForm);
	...
	static public void main(String args[]) throws IOException {
	    ...
	    Treebank_KR_DataBuilder builder = new Treebank_KR_DataBuilder(trainStream, testStream);
